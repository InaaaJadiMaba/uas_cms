...
function kids_campus_setup() {		
	$GLOBALS['content_width'] = apply_filters( 'kids_campus_content_width', 680 );
...
define('kids_campus_theme_doc',__('http://www.gracethemesdemo.com/documentation/kids-campus/#homepage-lite','kids-campus'));
define('kids_campus_protheme_url',__('https://gracethemes.com/themes/kindergarten-wordpress-theme/','kids-campus'));
define('kids_campus_live_demo',__('http://www.gracethemesdemo.com/kids-campus/','kids-campus'));
 ...
 */
add_action( 'after_setup_theme', 'kids_campus_setup_woocommerce_support' );
function kids_campus_setup_woocommerce_support()   
{
